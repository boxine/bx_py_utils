...
* [`is_uuid()`](https://github.com/boxine/bx_py_utils/blob/master/bx_py_utils/string_utils.py#L105-L127) - Generate a UUID instance from the given text in a determinism may via SHA224 hash.
